...
export default {
  ...
  description: "Composite device with 1-4 buttons (expose action), RGB LED (expose rgb light) and local haptic feedback.",
  ota: true,
  extend: [
    ...
    m.enumLookup({
      name: "feedback",
      label: "Buttons Options - Local Feedback Type",
      ...
      endpointNames: ["button_actions"],
      cluster: clst.manuButtonOptions,
      attribute: { ID: attr.localFeedback, type: Zcl.DataType.ENUM8 },
      access: "ALL",
    }),
    m.enumLookup({
      name: "feedback_color",
